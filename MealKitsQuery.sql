...
-- VALUES ('Martina Kay Basquez', '???????@gmail.com', 'Premium', '1996-09-19', NULL, 'TX');
...
-- % takes any sequence of characters before the .edu
-- SELECT * FROM Customers
-- WHERE Email LIKE '%.edu';

-- Easy way to check is to use Select instead of Delete
-- SELECT * FROM Customers
...
-- VALUES
-- ('Chicken Quesadilla', 600, 9.99, 0, 'Premium'),
-- ('Frosted Flakes', 220, 5.99, 1, 'Standard'),
-- ('Cheese Pizza', 700, 7.99, 1, 'Standard')
...
-- If two meals have the same price
-- SELECT * FROM Meals
